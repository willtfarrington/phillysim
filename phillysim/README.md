...
| Measure | Baseline | Budget (architecture.md) |
|---|---|---|
| CI performance smoke: `phillysim run --fixture` as a child under the sampler | 1.3 s wall, peak RSS 140 MiB, 10 samples at 10 Hz on the development machine; CI run 33810585588: Linux 0.7 s wall, peak RSS 215 MiB, 7 samples, Windows 1.5 s wall, peak RSS 136 MiB, 15 samples | 60 s / 2 GiB test bounds |
