...
|---|---|---|---|---|
| OQ-A | City Open Data Program reply to derivative-reuse confirmation email | owner (sent/managed by author) | before v1.0.0 release notes finalize the licensing prose | None blocking — documented contextual-inference position stands; a reply upgrades inference to fact |
