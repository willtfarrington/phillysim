...
| Performance smoke | stage runtimes/memory vs budgets on fixture | CI | not yet; baselines recorded in `phillysim/README.md` (EP-9 fixture-scale; EP-10 the real pipeline from a fresh clone); the CI test lands with the M3 spike |
